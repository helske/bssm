...
// [[Rcpp::export]]
Rcpp::List bootstrap_filter(const Rcpp::List& model_,
...
// [[Rcpp::export]]
Rcpp::List bootstrap_smoother(const Rcpp::List& model_,
  const unsigned int nsim_states, const unsigned int seed, const int model_type) {
...
// [[Rcpp::export]]
Rcpp::List bootstrap_filter_nlg(const arma::mat& y, SEXP Z_fn_, SEXP H_fn_, 
