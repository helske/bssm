...
#'
#' @srrstats {BS1.0, BS1.1, BS1.2, BS1.2a, BS1.2b} Addressed in the models.R, 
#' run_mcmc.R, in vignettes and in the R Journal paper.
#'
#'
#' @srrstats {BS2.1, BS2.1a} Tested by autotest and package examples/tests.
```
...
increased usability and stability.
...
Consider the daily air quality measurements in New Your from May to September 1973, available in the `datasets` package. Let's try to predict the missing ozone levels by simple linear-Gaussian local linear trend model with temperature and wind as explanatory variables:
