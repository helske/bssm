...
title: 'bssm: Bayesian Inference of Non-linear and Non-Gaussian State Space Models
  in R'
author:
- Jouni Helske^[LinkÃ¶ping University, Department of Science and Technology, Sweden,
  University of JyvÃ¤skylÃ¤, Department of Mathematics and Statistics, Finland]
- Matti Vihola^[University of JyvÃ¤skylÃ¤, Department of Mathematics and Statistics,
  Finland]
...
vignette: |
  %\VignetteIndexEntry{bssm: Bayesian Inference of Non-linear and Non-Gaussian State Space Models in R} %\VignetteEngine{knitr::rmarkdown} %\VignetteEncoding{UTF-8} %\VignetteDepends{ggplot2, bayesplot, sde, ramcmc, sitmo}
---
