...
vignette: >
 %\VignetteIndexEntry{bssm: Bayesian Inference of Non-linear and Non-Gaussian State Space Models in R}
  ...
  %\VignetteDepends{ggplot2, dplyr, sde, ramcmc, sitmo}
---
...
**Note: this vignette is currently partially out of synch with the latest changes (version 1.0.0) of bssm. Will be updated soon (had to meet CRAN deadline before finishing)**
...
d <- as.data.frame(mcmc_bsm, "theta")
...
d <- as.data.frame(mcmc_bsm, "states")
summary_y <- d %>% 
