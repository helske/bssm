...
This takes a few seconds. let's define our initial guess for $\theta$, the standard deviation of observational level noise, the standard deviations of the process noises, and define the prior distribution for $\alpha_1$:
...
mcmc_res <- run_mcmc(model, iter = 6000, burnin = 1000, nsim = 10, 
