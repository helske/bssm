...
This takes a few seconds. let's define our initial guess for $\theta$, the logarithms of the standard deviations of observational and process level noise (we use log-scale in sampling for efficiency reasons, but define priors for the standard deviation, see the template file), and define the prior distribution for $\alpha_1$:

```{r theta}
initial_theta <- c(log_H = log(1.2), log_R1 = log(0.1), log_R2 = log(0.5))
