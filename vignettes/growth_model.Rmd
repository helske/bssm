...
ts.plot(out_smoother$alphahat[,1], out_psi_smoother$alphahat[, 1], out_bsf_smoother$alphahat[, 1], col = 1:3)
```
...
```{r mcmc}
out_mcmc_pm <- run_mcmc(model, n_iter = 2e4, nsim_states = 50, method = "pm", 
  simulation_method = "psi")
out_mcmc_ekf <- run_mcmc(model, n_iter = 2e4, method = "ekf")
