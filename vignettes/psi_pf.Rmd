...
sumr %>% arrange(N) %>% knitr::kable(digit = 4)
```
...
print("Running with 10000 particles")
ar_result_10000 <- ar_exp_model_experiment(1, 10000, 10000, 0.1) 
saveRDS(ar_result_10000, file = "ar_result_10000.rds")
```
...
#ar10000 <- readRDS("psi_pf_experiments/ar_result_10000.rds")

results <- rbind(ar10, ar100, ar1000)#, ar10000)
```
