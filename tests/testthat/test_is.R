...
test_that("Test that poisson ng_bsm give identical results with ngssm",{
  ...
  testvalues <- structure(c(1.33288345256985, 0.979030809094139, 1.73347913263807, 
    0.312770093194118), .Dim = c(4L, 1L))
...
test_that("Test that svm still works",{
  ...
  testvalues <- structure(c(5.86702179982002, 0.215967278599225, 0.0735471187105569, 
    0.64491606343298), .Dim = c(4L, 1L))
